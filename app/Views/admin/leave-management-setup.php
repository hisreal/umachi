...
$extraStyles = ['css/clock-in.css', 'css/admin-dashboard.css', 'css/leave-management.css'];
$extraScripts = $extraScripts ?? ['js/admin-dashboard.js', 'js/leave-management.js'];
...
require __DIR__ . '/leave-management-data.php';