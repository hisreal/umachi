...
<main class="clock-in-page leave-module-page">
    ...
    <section class="container-fluid clock-workspace">
        <form class="leave-settings-form needs-validation" id="leaveApprovalSettingsForm" novalidate>
            <div class="row g-4">
                <div class="col-xl-7">
                ...
                <div class="col-xl-5">
                    <article class="app-card card leave-form-card h-100">
                        ...
                        <div class="leave-settings-grid">
                            <div class="form-check form-switch leave-switch"><input class="form-check-input" type="checkbox" id="allowCancellation" checked><label class="form-check-label" for="allowCancellation">Allow Leave Cancellation</label></div>
                            <div class="form-check form-switch leave-switch"><input class="form-check-input" type="checkbox" id="requireDocuments" checked><label class="form-check-label" for="requireDocuments">Require Supporting Documents</label></div>
                            <div class="form-check form-switch leave-switch"><input class="form-check-input" type="checkbox" id="notifyApprovers" checked><label class="form-check-label" for="notifyApprovers">Notify Approvers</label></div>
                            <div class="form-check form-switch leave-switch"><input class="form-check-input" type="checkbox" id="autoApproveEmergency"><label class="form-check-label" for="autoApproveEmergency">Auto Approve Emergency Leave</label></div>
                            <div class="form-check form-switch leave-switch"><input class="form-check-input" type="checkbox" id="allowHalfDay" checked><label class="form-check-label" for="allowHalfDay">Allow Half-Day Leave</label></div>
                            <div><label class="form-label" for="maxRequests">Maximum Leave Requests Per Year</label><input class="form-control" id="maxRequests" type="number" min="1" value="12" required></div>
                            <div><label class="form-label" for="approvalDeadline">Approval Deadline (Hours)</label><input class="form-control" id="approvalDeadline" type="number" min="1" value="48" required></div>
                        </div>
                    </article>
                </div>
            </div>
