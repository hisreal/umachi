                    ...
                    <?php else: ?>
                        <?php foreach ($attendanceRecords as $record): ?>
                            <tr data-attendance-row data-search="<?php echo e(strtolower($record['name'] . ' ' . $record['employee_id'])); ?>" data-date="<?php echo e($record['date']); ?>" data-department="<?php echo e($record['department']); ?>" data-role="<?php echo e($record['role']); ?>" data-employee="<?php echo e($record['name']); ?>" data-shift="<?php echo e($record['shift']); ?>" data-status="<?php echo e($record['status']); ?>">
                                <td><?php echo e(format_date($record['date'])); ?></td><td><strong><?php echo e($record['employee_id']); ?></strong></td><td><?php echo e($record['name']); ?></td><td><?php echo e($record['department']); ?></td><td><?php echo e($record['role']); ?></td><td><?php echo e($record['clock_in']); ?></td><td><?php echo e($record['clock_out']); ?></td><td><?php echo e($record['shift']); ?></td><td><span class="table-badge <?php echo e($attendanceStatusClasses[$record['status']] ?? ''); ?>"><?php echo e($record['status']); ?></span></td><td><?php echo e($record['remarks']); ?></td>
                                <td>
