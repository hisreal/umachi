...
$extraStyles = ['css/clock-in.css', 'css/admin-dashboard.css', 'css/profile-management.css'];
$extraScripts = $extraScripts ?? ['js/admin-dashboard.js', 'js/profile-management.js'];
...
require __DIR__ . '/profile-management-data.php';