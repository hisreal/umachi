...
<head>
    ...
    <title>Welcome to <?php echo htmlspecialchars((string) $companyName, ENT_QUOTES, 'UTF-8'); ?></title>
    <style>
...
<body style="margin:0; padding:0; background-color:#f3f6f4; color:#24312b; font-family:Arial, Helvetica, sans-serif; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%;">
    <div style="display:none; max-height:0; overflow:hidden; opacity:0; color:transparent;">
        Your employee account has been created. Access your login details and welcome information.
    </div>
        ...
        <tr>
            <td align="center" style="padding:32px 12px;">
                <table role="presentation" class="email-shell" width="600" cellspacing="0" cellpadding="0" border="0" style="width:600px; max-width:600px; border-collapse:separate; background-color:#ffffff; border-radius:18px; overflow:hidden; box-shadow:0 8px 28px rgba(20, 62, 43, 0.10);">
                    <tr>
                        <td class="email-header" align="center" style="padding:38px 36px; background-color:#145c3d; background-image:linear-gradient(135deg, #145c3d 0%, #0f7951 100%);">
                            ...
                            <p style="margin:0 0 8px; color:#d8f1e6; font-size:14px; line-height:20px; font-weight:700; letter-spacing:1px; text-transform:uppercase;"><?php echo htmlspecialchars((string) $companyName, ENT_QUOTES, 'UTF-8'); ?></p>
                            <h1 style="margin:0; color:#ffffff; font-size:29px; line-height:38px; font-weight:700;">Welcome to <?php echo htmlspecialchars((string) $companyName, ENT_QUOTES, 'UTF-8'); ?></h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:36px 42px 18px;">
                            ...
                            <p style="margin:0; color:#526159; font-size:15px; line-height:25px;">Congratulations and welcome to the <?php echo htmlspecialchars((string) $companyName, ENT_QUOTES, 'UTF-8'); ?> team! We are excited to have you join our organization. Your employee account has been successfully created, and you can now access the Staff Management System using the login credentials below.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:18px 42px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:separate; background-color:#f7faf8; border:1px solid #dce9e2; border-radius:14px;">
                                <tr>
                                    <td colspan="2" style="padding:20px 22px 12px; color:#145c3d; font-size:18px; line-height:25px; font-weight:700;">Login Information</td>
                                </tr>
                                <tr>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="width:100%; border-collapse:separate; background-color:#fff8e8; border:1px solid #f3d493; border-radius:12px;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        <p style="margin:0 0 10px; color:#7b4c00; font-size:15px; line-height:22px; font-weight:700;">&#9888;&#65039; Important Security Notice</p>
                    ...
                    <tr>
                        <td align="center" style="padding:28px 30px; background-color:#eaf1ed; border-top:1px solid #dce6e0;">
                            <p style="margin:0 0 7px; color:#145c3d; font-size:14px; line-height:20px; font-weight:700;"><?php echo htmlspecialchars((string) $companyName, ENT_QUOTES, 'UTF-8'); ?></p>
